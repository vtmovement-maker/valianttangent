...
pygame.display.set_caption("Pet Friends!")
...
try:
    original_landscape = load_image("landscape.png", (SCREEN_WIDTH, SCREEN_HEIGHT))
except:
...
acorn_image = load_image("acorn.png", ACORN_SIZE, "🌰", PET_FONT)

HH_PET_SIZE = (225, 180)
hh_images = {
    "happy": load_image("happyhh.png", HH_PET_SIZE, "🦔", PET_FONT),
    "sad": load_image("sadhh.png", HH_PET_SIZE, "😞", PET_FONT),
    "sleep": load_image("sleephh.png", HH_PET_SIZE, "😴", PET_FONT),
    "tired": load_image("tiredhh.png", HH_PET_SIZE, "😞", PET_FONT),
    "fat": load_image("fathh.png", HH_PET_SIZE, "🦔", PET_FONT),
}

SQ_PET_SIZE = (200, 180)
sq_images = {
    "happy": load_image("happysq.png", SQ_PET_SIZE, "🐿️", PET_FONT),
    "sad": load_image("sadsq.png", SQ_PET_SIZE, "😞", PET_FONT),
    "tired": load_image("tiredsq.png", SQ_PET_SIZE, "😞", PET_FONT),
    "sleep": load_image("sleepsq.png", SQ_PET_SIZE, "😴", PET_FONT),
    "fat": load_image("fatsq.png", SQ_PET_SIZE, "🐿️", PET_FONT),
}

POOP_SIZE = (40, 40)
poop_images = [
    load_image("poop1.png", POOP_SIZE, "💩", PET_FONT),
    load_image("poop2.png", POOP_SIZE, "💩", PET_FONT),
    load_image("poop3.png", POOP_SIZE, "💩", PET_FONT)
]
poop_images = [img for img in poop_images if img is not None]

FLY_SIZE = (50, 40)
fly_image_right = load_image("fly1.png", FLY_SIZE, "🦟", PET_FONT)
fly_image_left = load_image("fly2.png", FLY_SIZE, "🦟", PET_FONT)

EXPLOSION_SIZE = (70, 70)
explosion_images = [
    load_image("explosion1.png", EXPLOSION_SIZE),
    load_image("explosion2.png", EXPLOSION_SIZE),
    load_image("explosion3.png", EXPLOSION_SIZE)
]
...
for filename in ["poop.wav", "poop2.wav", "poop3.wav"]:
    try:
        poop_sounds.append(pygame.mixer.Sound(filename))
    except pygame.error:
...
try:
    cannon_sound = pygame.mixer.Sound("cannon.wav")
except pygame.error:
    cannon_sound = None

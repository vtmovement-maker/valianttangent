...
# Resolve paths relative to this script file, regardless of where it's run from
...
PET_SIZE = (225, 180) 
pet_happy_img = load_image(res("happyhh.png"), PET_SIZE, "🦔", PET_FONT)
pet_sad_img = load_image(res("sadhh.png"), PET_SIZE, "😞", PET_FONT)
pet_sleep_img = load_image(res("sleephh.png"), PET_SIZE, "😴", PET_FONT)
# ### NEW: Explicitly loading the tired image for the tired state ###
pet_tired_img = load_image(res("tiredhh.png"), PET_SIZE, "😞", PET_FONT)
